...
import VerificationPhoneNumber from "@/Components/Organisms/PhoneNumberVerification";
...
export default function Publish({
  ...
  async function handlePublishGig() {
    ...
    try {
      ...
      router.prefetch("/manage_gigs?status=published");
      router.push("/manage_gigs?status=published");
    } catch (err) {
      console.log(err);
    }
  }
