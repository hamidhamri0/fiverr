...
export default function ReviewBar({
  ...
  return <div className="flex h-4 items-center gap-2 text-gray-700">
      ...
      <div className="h-full w-full rounded-full bg-gray-200 dark:bg-gray-700">
        <div style={{
        width: `${percentage}%`
      }} className="h-full rounded-full bg-black p-0.5 text-center text-xs font-medium leading-none text-blue-100"></div>
      </div>
